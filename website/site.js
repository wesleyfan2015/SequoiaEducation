...
function renderVideoStoryGallery() {
  const storyVideos = [
  ...
  return `
    <section class="section alt" id="events-video-gallery">
      <div class="section-inner">
        <div class="section-head">
          <div>
            <p class="eyebrow">Events Video Gallery / \u6d3b\u52a8\u89c6\u9891\u8f6e\u64ad</p>
            <h2>Sequoia events in motion</h2>
          </div>
        </div>
        <div class="about-roll about-video-roll" aria-label="Sequoia events video carousel">
